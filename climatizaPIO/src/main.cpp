...
#define DHTPIN        22    // DHT11 dados conectado ao GPIO22 (D22)
#define DHTTYPE       DHT11

#define TEMP_POT_PIN  4     // Potenciômetro de temperatura simulada no GPIO4 (D2)
#define HUM_POT_PIN   2     // Potenciômetro de umidade simulada no GPIO2 (D4)
#define PRES_POT_PIN  15    // Potenciômetro de presença simulada no GPIO15 (D15)

#define FAN_LED_PIN   5     // LED/futura ventoinha no GPIO5
